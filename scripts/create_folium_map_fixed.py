...
class ShelterAQIMapFixed:
    ...
    def fetch_aqi_data(self):
        ...
        mock_stations = [
            ...
            {"SiteName": "高雄", "County": "高雄市", "AQI": 150, "lat": 22.6273, "lon": 120.3014},
            ...
            {"SiteName": "林口", "County": "新北市", "AQI": 120, "lat": 25.0777, "lon": 121.3163},
        ]
    ...
    def load_shelter_data(self):
        ...
        try:
            self.shelter_data = pd.read_csv('data/shelters_cleaned.csv', encoding='utf-8-sig')
    ...
    def create_interactive_map(self):
        ...
        # 儲存地圖
        output_file = 'outputs/shelter_aqi_interactive_map_fixed.html'
        m.save(output_file)
...
def main():
    """主程式"""
    print("開始創建 AQI 與避難所互動式地圖（修正版）...")
    
    # 確保輸出目錄存在
    os.makedirs('outputs', exist_ok=True)
    
    # 創建地圖
    map_creator = ShelterAQIMapFixed()
    
    if map_creator.create_interactive_map():
        print(f"\n地圖創建完成！")
        print(f"輸出檔案: outputs/shelter_aqi_interactive_map_fixed.html")
        print(f"可在瀏覽器中開啟查看互動式地圖")
        print(f"AQI測站和避難所已成功疊圖顯示")
    else:
        print(f"地圖創建失敗！")
